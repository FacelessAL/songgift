...
export const metadata: Metadata = {
  ...
  description: "Create a personalized song for your best friend that celebrates your friendship. We, 24–48 hr delivery. The most thoughtful friendship gift ever.",
