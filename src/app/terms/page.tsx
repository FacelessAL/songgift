        ...
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-10">
            ...
            <div>
              ...
              <div className="pl-10 space-y-3">
                <p className="text-text-muted leading-relaxed text-sm"><strong className="text-text-dark">Delivery Timeline:</strong> Standard delivery is within 48 hours of order confirmation. Rush delivery (within 24 hours) is available for an additional fee. Delivery times are estimates and may vary based on order volume and complexity. We will notify you of any significant delays.</p>
